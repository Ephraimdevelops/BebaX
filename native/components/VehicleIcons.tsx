...
// --- OPTIMIZED SVG ASSETS (Inline Components) ---
// Colors: #121212 (Asphalt) for body, #FF5722 (Safety Orange) for accents
...
export const BodaIcon = ({ color, width = 40, height = 40 }: IconProps) => (
...
export const BajajIcon = ({ color, width = 40, height = 40 }: IconProps) => (
    <Svg width={width} height={height} viewBox="0 0 24 24" fill="none">
...
// Kirikuu: Boxy, Cab-over-engine
export const KirikuuIcon = ({ color, width = 40, height = 40 }: IconProps) => (
    <Svg width={width} height={height} viewBox="0 0 24 24" fill="none">
...
// Pickup Single: Long bed
export const PickupSIcon = ({ color, width = 40, height = 40 }: IconProps) => (
    <Svg width={width} height={height} viewBox="0 0 24 24" fill="none">
...
// Pickup Double: Short bed, 4 pax
export const PickupDIcon = ({ color, width = 40, height = 40 }: IconProps) => (
    <Svg width={width} height={height} viewBox="0 0 24 24" fill="none">
...
export const TruckIcon = ({ color, width = 40, height = 40 }: IconProps) => (
    <Svg width={width} height={height} viewBox="0 0 24 24" fill="none">
...
export const SemiIcon = ({ color, width = 40, height = 40 }: IconProps) => (
    <Svg width={width} height={height} viewBox="0 0 24 24" fill="none">
...
export const getIcon = (id: string) => {
    if (id === 'boda') return BodaIcon;
    if (id === 'bajaj') return BajajIcon;
    if (id === 'kirikuu') return KirikuuIcon;
    if (id === 'pickup_s') return PickupSIcon;
    if (id === 'pickup_d') return PickupDIcon;
    if (id === 'semi') return SemiIcon;
    return TruckIcon;
};
